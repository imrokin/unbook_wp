...
Tags: Piklist, Admin Bar, AIM, Autosave, Comments, Close Comments, Dashboard Widgets, Emojis, Excerpt, Excerpts, Exif, Featured Image, Feeds, Google Talk, Howdy, HTML Editor, Image, Jabber, Maintenance, Maintenance Mode, Media, Private, Protected, Revisions, RSS Feeds, Settings, Under Construction, Visual Editor, Widgets, xmlrpc, Yahoo IM
Tested up to: 4.5
...
* ENHANCED: Exif data in arrays display as expected.


= 1.14.0 =
Release Date: July 28, 2016

* ENHANCED: Front notice style.
* FIXED: Notice when no exif data.

= 1.13.0 =

* NEW: add Categories and Tags to Media [Media > Categories / Tags]
* FIXED: Link to Maintenance Mode settings is correct.
* FIXED: Notices work as expected.
* REMOVED: "Remove profile fields" setting.

= 1.12.0 =
Release Date: June 29, 2016

* NEW: Disable Theme and Plugin editors [General > Theme and plugin editors]

= 1.11.0 =
Release Date: June 28, 2016

* FIXED: Redirects work as intended [Reading > Redirects]

= 1.10.0 =
Release Date: June 13, 2016

* NEW: Control number of revisions to save [Writing > Number of Revisions to save]

= 1.9.9 =
Release Date: June 10, 2016

* ENHANCED: Allow other plugins to override the Email From/Name settings.

= 1.9.8 =
Release Date: May 10, 2016

* NEW: Allow redirection on login via redirect_to parameter.

= 1.9.7 =
Release Date: April 22, 2016

* NEW: Easily Redirect 404's to any page.[Reading > Redirects]

= 1.9.6 =
* ENHANCED: Login logo resizes if too large.
